...
const Realstate = () => {
   ...
   return (
     ...
     {images.map((image, index) => (
       ...
       <p className="p-4 fs-5 fw-b" style={{fontWeight:"bold"}}>RealState</p>
       <ul className="fs-5" style={{ marginBottom:"3rem"}}>
         ...
         <li>
           ...
           A simple RealState website with that i created with the name of Homyz when i started Learning. Please check my GitHub profile for code 😊
           </span>
         </li>
       </ul>
